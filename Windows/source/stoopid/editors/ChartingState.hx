...
import stoopid.Conductor.BPMChangeEvent;
...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function updateGrid():Void
	{
		...
		if (_variables.fiveK)
			row = 10;
		gridBG = FlxGridOverlay.create(GRID_SIZE, Std.int(GRID_SIZE * gridYScale), GRID_SIZE * row,
			Std.int(GRID_SIZE * gridYScale) * _song.notes[curSection].lengthInSteps);
		add(gridBG);
