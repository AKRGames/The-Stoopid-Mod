...
class MenuModifiers extends MusicBeatState
{
	...
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('Modi_Checker'));
		...
		if (!modifierList[curSelected].abs)
			...
			else
			{
				if (modifierList[curSelected].curValue < modifierList[curSelected].offAt)
					...
					{
						modifierList[curSelected].realmulti = modifierList[curSelected].multi
							- modifierList[curSelected].multi * modifierList[curSelected].offAt;

						trace(modifierList[curSelected].multi
							+ "-"
							+ modifierList[curSelected].multi + '*' + modifierList[curSelected].offAt + '=' + modifierList[curSelected].realmulti);
					}
					else
					{
						modifierList[curSelected].realmulti = modifierList[curSelected].multi * modifierList[curSelected].curValue
						...
						trace(modifierList[curSelected].multi
							+ "*"
							+ modifierList[curSelected].curValue + '-' + modifierList[curSelected].multi + "*" + modifierList[curSelected].offAt + '=' +
								modifierList[curSelected].realmulti);
					}
			}
		else
