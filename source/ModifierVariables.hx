...
class ModifierVariables
{
    ...
    public static function modifierSetup():Void
    {
        MenuModifiers.modifierList = [
            {name: 'Practice Mode', value: false, conflicts: [1,2,3,4,5,6,8,9,10,32,33], multi: 0, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you're a certified pussy, and you should be proud of it. after all, practice makes perfect! \nscore multiplier: x0."},
            {name: 'Single Digits Only (SDCB)', value: false, conflicts: [0,2,3,4,5,8,9,10,11,24,32,33,34], multi: 1.5, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "try to miss less than 10 times, okay? \nscore multiplier: x1.5."},
            {name: 'No Misses (FC)', value: false, conflicts: [0,1,3,4,5,8,9,10,11,24,32,33,34], multi: 3, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you can't miss bro. \nscore multiplier: x3."},
            {name: 'Try not to "shit"! (AFC)', value: false, conflicts: [0,1,2,4,5,8,9,10,11,24,32,33,34], multi: 5, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "hold it in bro. don't 'Shit', amirite ? \nscore multiplier: x5."},
            {name: 'Only your GF can be a BADdie! (GFC)', value: false, conflicts: [0,1,2,3,5,8,9,10,11,24,32,33,34], multi: 7, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you don't want to be BAD, do you? then don't get bad. \nscore multiplier: x7."},
            {name: 'Ascension (MFC)', value: false, conflicts: [0,1,2,3,4,8,9,10,11,24,32,33,34], multi: 9, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you can do this, all you have to do is to not score a 'Good', it's very easy.\nscore multiplier: x9."},
            {name: 'Lives', value: false, conflicts: [0], multi: 0.6, realmulti: 0, equation: 'division', abs: false,  revAtLow: false, type: 'number', minValue: 1, maxValue: 15, curValue: 1, offAt: 1, addChange: 1, string: '\nHEART(S)', explanation: "how much lives bro? (fun fact, a cat has 9!) \nscore divider: 3/5 per life."},
            {name: 'Brightness', value: false, conflicts: [], multi: 0.005, realmulti: 0, equation: '', abs: true,  revAtLow: false, type: 'number', minValue: -100, maxValue: 100, curValue: 0, offAt: 0, addChange: 5, string: '%\nBRIGHTNESS', explanation: "how much brightness bro? \nscore rate: +0.025 per 5% or -5% of brightness."},
            {name: 'HP GET!', value: false, conflicts: [0,1,2,3,4,5], multi: -0.2, realmulti: 0, equation: '', abs: false,  revAtLow: true, type: 'number', minValue: 0, maxValue: 10, curValue: 1, offAt: 1, addChange: 0.5, string: 'x\nHEALTH GAIN', explanation: "how much more health bro? \nscore rate: -0.1 per amount."},
            {name: 'HP LOSE!', value: false, conflicts: [0,1,2,3,4,5], multi: 0.2, realmulti: 0, equation: '', abs: false,  revAtLow: true, type: 'number', minValue: 0, maxValue: 10, curValue: 1, offAt: 1, addChange: 0.5, string: 'x\nHEALTH LOSS', explanation: "how much less health bro? \nscore rate: +0.1 per amount."},
            {name: 'Starting HP', value: false, conflicts: [0,1,2,3,4,5], multi: -0.0025, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: -100, maxValue: 100, curValue: 0, offAt: 0, addChange: 5, string: '%\nMORE START\nHEALTH', explanation: "you gon' place your health or what? \nscore rate: +0.1 per amount."},
            {name: 'Did we get em?', value: false, conflicts: [1,2,3,4,5], multi: 0.3, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you wanna see your health bar or not? \nscore rate: +0.3."},
            {name: 'Vibe', value: false, conflicts: [], multi: -0.9, realmulti: 0, equation: '', abs: false,  revAtLow: true, type: 'number', minValue: 0.8, maxValue: 1.2, curValue: 1, offAt: 1, addChange: 0.2, string: 'x\nTHE VIBE', explanation: "mmm vibes. 1 = classic, 1.2 =s lofi and 0.8 = hifi."},
            {name: 'Offbeat', value: false, conflicts: [], multi: 0.001, realmulti: 0, equation: '', abs: true,  revAtLow: false, type: 'number', minValue: -1000, maxValue: 1000, curValue: 0, offAt: 0, addChange: 10, string: '%\nMORE NOTE\nOFFSET', explanation: "'ay man i don't do music like that i have OCD', you said. \nscore rate: +0.1. \nWARNING: YOU CAN GET BLUEBALLED IF YOU PUT IN A LARGE NEGATIVE VALUE."},
            {name: 'Safe Frames', value: false, conflicts: [], multi: -0.08, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: -8, maxValue: 30, curValue: 0, offAt: 0, addChange: 1, string: '\nMORE SAFE\nFRAMES', explanation: "how much frames do you want to save bro? \nscore rate: -0.1 per amount."},
            {name: 'Note Speed', value: false, conflicts: [], multi: 0.0125, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: -90, maxValue: 400, curValue: 0, offAt: 0, addChange: 2, string: '%\nMORE NOTE\nSPEED', explanation: "how speed are the notes gonna be bro? \nscore multiplier : x0.025 per amount. \nWARNING: YOU CAN GET BLUEBALLED IF YOU PUT IN A LARGE VALUE."},
            {name: 'Invisible Notes', value: false, conflicts: [17, 18, 19], multi: 2.5, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "you wanna see your notes or not? \nscore rate: +2.5."},
            {name: 'Snake Notes', value: false, conflicts: [16], multi: 0.003, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 300, curValue: 0, offAt: 0, addChange: 5, string: '%\nOF SNAKE\nMOVES', explanation: "y'know, Snake? from Metal Gear Solid? \nscore rate: +0.015 per amount."},
            {name: 'Drunk Notes', value: false, conflicts: [16], multi: 0.003, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 300, curValue: 0, offAt: 0, addChange: 5, string: '%\nOF DRUNK\nMOVES', explanation: "how many shots you took bro? \nscore rate: +0.015 per amount."},
            {name: 'Accelerant Notes', value: false, conflicts: [16], multi: 0.0045, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 300, curValue: 0, offAt: 0, addChange: 5, string: '%\nOF SPEED\nACCELERATION', explanation: "OMG? FNF ONLINE VS REFERENCE!!! \nscore rate: +0.0225 per amount. \nWARNING: PLEASE DON'T USE AT HIGH VALUES."},
            {name: 'Squint', value: false, conflicts: [16, 21], multi: 0.0045, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 100, curValue: 0, offAt: 0, addChange: 2, string: '%\nOF SCREEN\nHEIGHT', explanation: "why you squinting bro? \nscore rate: +0.009 per amount."},
            {name: 'You Cannot See', value: false, conflicts: [16, 20], multi: 0.0045, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 100, curValue: 0, offAt: 0, addChange: 2, string: '%\nOF SCREEN\nHEIGHT', explanation: "bro idk what to say anymore. \nscore rate: +0.009 per amount."},
            {name: 'Flipped Notes', value: false, conflicts: [16], multi: 0.5, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "the notes got flipped; left is right, up is down. \nscore rate: +0.5."},
            {name: 'Hyper Notes', value: false, conflicts: [], multi: 0.009, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 300, curValue: 0, offAt: 0, addChange: 5, string: '%\nOF SUGAR\nRUSH', explanation: "you're on a sugar crash, you ain't got no funkin cash. \nscore rate: +0.045 per amount. \nWARNING: IT GETS REALLY HARD AT HIGH VALUES."},
            {name: 'Eel Notes', value: false, conflicts: [1,2,3,4,5], multi: 0.01, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 100, curValue: 0, offAt: 0, addChange: 10, string: '%\nOF EXTRA\nLENGTH', explanation: "when an eel lunges out, and he takes a bite of your snout. \nWARNING: TOO MUCH MIGHT CAUSE NOTES TO OFTEN NOT RENDER PROPERLY 'CUZ THEN THEY'LL BE TOO MANY OF THEM. USE AT YOUR OWN RISK. \nTIP: you can hold to possibly win."},
            {name: 'Stretched', value: false, conflicts: [], multi: 0.001, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 400, curValue: 0, offAt: 0, addChange: 5, string: '%\nMORE\nSTRETCHED\n', explanation: "damn why they tall... \nscore multiplier: x0.01."},
            {name: 'Widen', value: false, conflicts: [], multi: 0.001, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 400, curValue: 0, offAt: 0, addChange: 5, string: '%\nMORE\nWIDE', explanation: "damn why they thicc... \nscore multiplier: x0.01."},
            {name: 'Jack-TASTIC!', value: false, conflicts: [], multi: 1.5, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 500, curValue: 0, offAt: 0, addChange: 1, string: '\nMORE\nJACK(S)', explanation: "ah a a ahh ee ah ah ah jAcktAstIc! \nscore multiplier: x1.5 per amount. \nWARNING: IT'S ABSOLUTE BULLSHIT!"},
            {name: 'Camera Swing', value: false, conflicts: [], multi: 0.005, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 10000, curValue: 0, offAt: 0, addChange: 10, string: '%\nSHIP FEEL', explanation: "how much camera swing bro? \nscore rate: +0.05."},
            {name: 'Upside Down', value: false, conflicts: [], multi: 0.2, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "upside down. \nscore rate: +0.2."},
            {name: 'Mirror', value: false, conflicts: [], multi: 0.2, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "y'know, Mirror? by Porter Robinson? \nscore rate: +0.2."},
            {name: 'Camera Spin', value: false, conflicts: [], multi: 0.005, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 10000, curValue: 0, offAt: 0, addChange: 10, string: '%\nSPIN', explanation: "*insert Klaskii Romper here* \nscore rate: +0.05."},
            {name: 'EARFQUAKE', value: false, conflicts: [], multi: 0.006, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 500, curValue: 0, offAt: 0, addChange: 5, string: '%\nQUAKING', explanation: "for real, for real this time... \nscore rate: +0.03."},
            {name: 'I Love You!', value: false, conflicts: [0,1,2,3,4,5], multi: -0.006, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 500, curValue: 0, offAt: 0, addChange: 5, string: '%\nMORE LOVE', explanation: "you say that to your girlfriend, and she says that back to you. \nscore rate: -0.03."},
            {name: 'Poison Fright', value: false, conflicts: [0,1,2,3,4,5], multi: 0.006, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 500, curValue: 0, offAt: 0, addChange: 5, string: '%\nPOISON\nDOSE', explanation: "did you consume something that had poison? \nscore rate: +0.03. \nWARNING: YOU CAN GET BLUEBALLED IF YOU SET IT TOO HIGH."},
            {name: 'Across the Ass', value: false, conflicts: [0,1,2,3,4,5], multi: 0.006, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 500, curValue: 0, offAt: 0, addChange: 5, string: "%\nASS\nWHOOPIN'", explanation: "bro why yo ass red? \nscore rate: +0.03. WARNING: YOU CAN GET BLUEBALLED IF YOU SET IT TOO HIGH."},
            {name: 'Stage Fright', value: false, conflicts: [1,2,3,4,5], multi: 0.05, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 30, curValue: 0, offAt: 0, addChange: 1, string: '\nLESS\nMISSES', explanation: "who the funk said we don't need shy people in our society? \nYOU ARE GIVEN 30 MISSES BY 1 LESS MISS. \nscore rate: +0.05."},
            {name: 'Paparazzi', value: false, conflicts: [], multi: 0.004, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'number', minValue: 0, maxValue: 100, curValue: 0, offAt: 0, addChange: 1, string: '\nCAMERAMA(E)N', explanation: "i can't believe they exist. \nscore rate: +0.004."},
        ];
